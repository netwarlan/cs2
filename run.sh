...
[[ -z "$CS2_SERVER_GOTV_AUTORECORD" ]] && CS2_SERVER_GOTV_AUTORECORD="1"
[[ -z "$CS2_SERVER_GOTV_MAXCLIENTS" ]] && CS2_SERVER_GOTV_MAXCLIENTS="3"
[[ -z "$CS2_SERVER_GOTV_BROADCAST" ]] && CS2_SERVER_GOTV_BROADCAST="1"
[[ -z "$CS2_SERVER_LOGS_DIRECTORY" ]] && CS2_SERVER_LOGS_DIRECTORY="logs"
